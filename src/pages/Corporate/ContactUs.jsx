                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start">
                                ...
                                <Link to='https://www.google.com/maps/dir/?api=1&destination=A-223%2C+Sector+151%2C+Noida%2C+Uttar+Pradesh+201310' target="_blank"
                            ...
                            <div className="flex items-center">
                                ...
                                <Link to="tel:08130622279" style={{ textDecoration: 'none', color: 'black' }} className="text-gray-700">
                                  +91 9990555740
                                </Link>
                            </div>
                            <div className="flex items-center">
