    ...
    <footer className="bg-[#1A2A3A] w-full mt-10 text-white font-serif">
      <div className="mx-4 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div className="hidden sm:hidden md:block">
          ...
          <input type="email" placeholder="Your email address" className="w-full px-4 py-2 bg-gray-700 text-white rounded-md mb-3 focus:outline-none focus:ring-2 focus:ring-blue-500" />
          <button type="submit" style={{ borderRadius: '5px' }} className="w-full bg-[#075fac] hover:bg-[#6B9AC4] px-4 py-2 transition">Subscribe</button>
        </div>
