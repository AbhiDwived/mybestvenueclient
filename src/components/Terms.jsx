        ...
        <div className="lg:mx-15 px-4 py-8">
            ...
            <footer className="mt-12 text-gray-600 border-t pt-8">
                <div className="text-center space-y-2">
                    ...
                    <p>
                        <Link to="tel:9990058522" style={{textDecoration:'none',}} className="text-[#0D3F6A] hover:text-[#0D3F6A] ">9990058522</Link> |{' '}
                        <Link to="mailto:Info@dsyhospitality.com" style={{textDecoration:'none'}} className="text-[#0D3F6A] hover:text-[#0D3F6A]">Info@dsyhospitality.com</Link> |{' '}
                        <Link to="http://www.dsyhospitality.com" style={{textDecoration:'none'}} className="text-[#0D3F6A] hover:text-[#0D3F6A]" target="_blank" rel="noopener noreferrer">www.dsyhospitality.com</Link>
                    </p>
                </div>
            </footer>
        </div>
